...
import pandas as pd
import urllib3
import feedparser  # <-- NOVA BIBLIOTECA PARA LER RSS
import hashlib     # <-- Para gerar um ID numérico único para as notas
...
def coletar_dados_camara():
    ...
    url = "https://dadosabertos.camara.leg.br/api/v2/proposicoes?siglaTipo=PL&ordem=DESC&ordenarPor=id&itens=30&keywords=internacional"
